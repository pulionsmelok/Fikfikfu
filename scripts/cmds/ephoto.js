...
module.exports = {
  config: {
    ...
    countDown: 5,
    role: 0,
    shortDescription: "Generate stylish images",
    longDescription: "Generate stylish images using Ephoto360 templates",
    category: "textmaker",
    guide: "/ephoto <template> <name>"
  },

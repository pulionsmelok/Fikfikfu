module.exports = {
  ...
  formatMoney(amount) {
    ...
    if (abs >= 1e15)
      return (amount / 1e15).toFixed(2).replace(/\.00$/, "") + "qt";
    if (abs >= 1e12)
      return (amount / 1e12).toFixed(2).replace(/\.00$/, "") + "treelion";
    if (abs >= 1e9)
      return (amount / 1e9).toFixed(2).replace(/\.00$/, "") + "bilon";
    if (abs >= 1e6)
      return (amount / 1e6).toFixed(2).replace(/\.00$/, "") + "milon";
    if (abs >= 1e3)

module.exports.config = {
	...
	description: "Send a random romantic/sad caption",
	category: "caption",
...
module.exports.onStart = async ({ api, event }) => {
	...
	/*
	 * Telegram adapter event.mentions এ:
	 * {
	 *   "USER_ID": "name"
	 * }
	 *
	 * তাই Messenger-এর Object.keys(event.mentions)
	 * একইভাবে Telegram-এর text_mention-এর ক্ষেত্রেও কাজ করবে।
	 */
